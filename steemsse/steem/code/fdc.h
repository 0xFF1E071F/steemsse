...
#else//!defined(SSE_STRUCTURE_FDC_H)
...
#if defined(STEVEN_SEAGAL) && (defined(SSE_FDC)||defined(SSE_DMA))
...
#if defined(STEVEN_SEAGAL) && defined(SSE_FDC_RESTORE_AGENDA)
...
#endif//!defined(SSE_STRUCTURE_FDC_H)