...
set PROGRAMNAME=Beta BCC LE D3D.exe
...
echo -----------------------------------------------
"%BCCPATH%make.exe" -fmake_LE.txt -DDONT_ALLOW_DEBUG -DSTEVEN_SEAGAL  -DSSE_D3D 3rdparty
...
echo ------------------------------------------
"%BCCPATH%make.exe" -fmake_LE.txt -DDONT_ALLOW_DEBUG -DBCC_BUILD -DSTEVEN_SEAGAL  -DSSE_D3D
